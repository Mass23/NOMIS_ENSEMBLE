...
data = pd.read_csv('B4_contigs.fasta_4mers.csv', sep = '\t')

eukaryotic_contigs = pd.read_csv('euk_B4.txt', sep = '\t', header = None)
eukaryotic_contigs = [i.split(' ')[0] for i in eukaryotic_contigs[0]]

prokaryotic_contigs = pd.read_csv('pro_B4.tsv', sep = '\t', header = None)
